...
def get_class_string_from_index(index):
    print(valid_generator.class_indices, "valid generator image indices")
...
saved_model_path = os.path.join(os.path.dirname(__file__), "../", f"file_storage/saved_flowers_model_{model_name}")
